...
;(function(){
  ...
  if ('number' == typeof $$obj.length) {
      for (var index = 0, $$l = $$obj.length; index < $$l; index++) {
        var item = $$obj[index];
;pug_debug_line = 1;pug_debug_filename = "components\u002Fmenu\u002F__item\u002Fmenu__item.pug";
pug_html = pug_html + "\u003Cli" + (" class=\"pure-menu-item\""+pug_attr("data-item", index, true, false)) + "\u003E";
;pug_debug_line = 2;pug_debug_filename = "components\u002Fmenu\u002F__item\u002Fmenu__item.pug";
pug_html = pug_html + "\u003Ca" + (" class=\"pure-menu-link\""+pug_attr("href", item.href, true, false)+" data-action=\"pick\"") + "\u003E";
;pug_debug_line = 5;pug_debug_filename = "components\u002Fmenu\u002F__item\u002Fmenu__item.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = item.anchor) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
;pug_debug_line = 6;pug_debug_filename = "components\u002Fmenu\u002F__item\u002Fmenu__item.pug";
pug_html = pug_html + "\u003Ci class=\"close\" data-action=\"remove\"\u003E\u003C\u002Fi\u003E\u003C\u002Fli\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Ful\u003E\u003C\u002Fdiv\u003E";}.call(this,"items" in locals_for_with?locals_for_with.items:typeof items!=="undefined"?items:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}